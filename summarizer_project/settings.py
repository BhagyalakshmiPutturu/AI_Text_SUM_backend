...
SECRET_KEY = 'django-insecure-&o&scakme=i4@^5$xy-+4sbm0$n9jbyj3q3g=uwg3w9xi(tg-g'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Summarizer',  # Replace with your DB name
        'USER': 'postgres',  # Replace with your PostgreSQL username
        'PASSWORD': 'Nithya@123',  # Replace with your PostgreSQL password
